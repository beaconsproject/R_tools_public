...
- [summarize_representation_results()](summarize_representation_results.qmd)
- [gen_network_names()](gen_network_names.qmd)
...
The function [summarize_representation_results()](summarize_representation_results.html) summarize representation results by network.


### gen_network_names

The function [gen_network_names()](gen_network_names.html) create a vector of network names.
