...
Another approach focus on the second type of representation analysis, a target-based approach using proportional representation. The latter ensure specific target areas of different representation classes are met in one or multiple conservation areas.  
