...
```{r landcover-piechart, fig.width=10, fig.height=6, fig.cap="**Pie charts of landcover class proportions by conservation area**",  message=FALSE, warning=FALSE, fig.show='hold'}
# Load libraries
library(sf)
library(terra)
library(dplyr)
